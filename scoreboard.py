...
class Scoreboard():
    ...
    def prep_score(self):
        """Turn the score into a recorded score"""
    ...
    def prep_level(self):
        """Turn the level number into a renedered image."""
        self.level_image = self.font.render(str(self.stats.level), True, self.text_colour, self.ai_settings.bg_color)
